...
public class IngredientsLoader extends AsyncTaskLoader<ArrayList> {

    private ArrayList mResult;
    private Context context;
    private int recipeId;

    public IngredientsLoader(Context context, int recipeId) {
        super(context);
    ...
    public ArrayList loadInBackground() {
        return NetworkUtils.fetchData(context, Constants.INGREDIENT_KEY, recipeId);
